function drawGame(){
	...
	const pleyer=new Pleyer({scene:scene,rotate:{x:0,y:radians(180),z:0},pos:{x:0,y:0,z:500},scale:{x:0.25,y:0.25,z:0.25},car:"carPleyer.obj",materialCar:[new THREE.MeshBasicMaterial({map:texture.load("Rx7_rx9_rx7_color_color.png")}),new THREE.MeshBasicMaterial({map:texture.load("Rx7_rx9_wheels_color_color.png")})]});
